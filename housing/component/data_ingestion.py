...
class DataIngestion:
    ...
    def download_housing_data(self,) -> str:
        try:
            #Extraction remote url to sownload dataset
            ...
            logging.info(f"downloading file fro [{download_url}] into [{tgz_file_path}]")
    ...
    def split_data_as_train_test(self) ->DataIngestionArtifact:
        try:
            ...
            if strat_test_set is not None:
                ...
                logging.info(f"Exportig train dataset to file : [{test_file_path}]")

...
class Configuration:
    ...
    def get_data_transformation_config(self) -> DataTransformationConfig:
        try:
            ...
            artifact_dir = self.training_pipeline_config.artifact_dir
            data_tranformation_artifact_dir = os.path.join(
                artifact_dir,
                DATA_TRASFORMATION_ARTIFACT_DIR,
                self.time_stamp
            )
            data_transformation_config = self.config_info[DATA_TRASFORMATION_CONFIG_KEY]
            
            add_bedroom_per_room=data_transformation_config[DATA_TRASFORMATION_ADD_BEDROOM_PER_ROOM_KEY]

            transformed_train_dir=os.path.join(
                data_tranformation_artifact_dir,
                data_transformation_config[DATA_TRASFORMATION_DIR_NAME_KEY],
            ...
            preprocessed_object_file_path=os.path.join(
                data_tranformation_artifact_dir,
                data_transformation_config[DATA_TRASFORMATION_PREPROCESSING_DIR_KEY],
                data_transformation_config[DATA_TRASFORMATION_PREPROCESSED_FILE_NAME_KEY]
            )
